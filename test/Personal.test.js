...
describe('Clixpesa Personal Spaces', function () {
  ...
  before(async () => {
    const personalContract = await ethers.getContractFactory('PersonalSpaces')
    ...
    PersonalIface = new ethers.utils.Interface((await artifacts.readArtifact('PersonalSpaces')).abi)
